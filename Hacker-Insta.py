...
ToKen = "5556991334:AAGb5Pzb6-x8vAe5mA0caOtdPwt6o_5SPOk"
admin=[5244755240,254264270,1403347605,5374908156]
bot = telebot.TeleBot(ToKen)
@bot.message_handler(commands=['start'])
def start_message(message):
    first = message.from_user.username
    bot.send_message(message.chat.id,f"    بُكَ فِيُ بُۅتِ صِيُډ يُۅࢪِ࣪ࢪاެتِ تِيُݪيُجَࢪاެمِ
اެݪبُۅتِ مِډفِۅعٰ ۅݪيُسُ مِجَاެنِيُ اެضِغِطَ /check
ݪكَيُ اެتِحِقِقِ هَݪ اެنِتِ مِشِتِࢪكَ فِيُ اެݪبُۅتِ ❤️‍🔥
___

اެنِ كَنِتِ ݪسُتِ مِشِتِࢪكَ ࢪاެسُݪ اެݪمِطَۅࢪ @S_Y_W ݪكَيُ يُفِعٰݪ ݪكَ اެݪاެشِتِࢪاެكَ بُمِقِاެبُݪ بُسُيُطَ جَډاެ ❤️‍🔥 @{first} ")
